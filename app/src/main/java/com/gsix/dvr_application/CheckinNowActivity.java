...
public class CheckinNowActivity extends AppCompatActivity {
    ...
    private String custtypestr, visitpurposestr,saveCurrentDate,saveCurrentTime,productRandomKey,CurrentUserId,tvLatitude,tvLongitude,CustomerName,VisitDetail;
